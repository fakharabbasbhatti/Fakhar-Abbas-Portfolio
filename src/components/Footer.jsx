...
const Footer = () => {
  ...
  return (
    <div>
      ...
      {alert && (
        <div
          className={`fixed top-4 left-1/2 transform -translate-x-1/2 w-full max-w-md p-4 rounded ${alert.type === "success" ? "bg-green-500" : "bg-red-500"} text-white flex justify-between items-center z-50`}
        >
